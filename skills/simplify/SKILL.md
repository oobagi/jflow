...
======================================
  ...
  Tests:               passing
  Reverted changes:    1 (test regression in auth module)
  ...
  Ready to ship with: /ship
======================================
```

If running inside `/autopilot`, do NOT prompt the user — just report and let autopilot continue.
