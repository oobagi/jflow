...
- End with a one-liner suggestion of what to do next based on the state (e.g. "You have uncommitted work on feature-x — pick up there?" or "Everything is clean — ready for new work.")
